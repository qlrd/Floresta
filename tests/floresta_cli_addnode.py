...
class GetAddnodeIDBErrorTest(FlorestaTestFramework):
    ...
    data_dirs = [
        os.path.normpath(
            os.path.join(tempfile.gettempdir(), "floresta-cli-addnode-test-node0")
        ),
        os.path.normpath(
            os.path.join(tempfile.gettempdir(), "floresta-cli-addnode-test-node1")
        ),
    ]
